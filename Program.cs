        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                for (int i = 0; i <= list.Count - 1; i++)
                {
                    ...
                    try
                    {
                        if (!Directory.Exists(caminhoAlvo + "Bustos Tratados\\" + valorAlbum))
                        {
                            Directory.CreateDirectory(caminhoAlvo + "Bustos Tratados\\" + valorAlbum);
                        }


                        File.Copy(arquivoOrigem, caminhoAlvo + "Bustos Tratados\\" + valorAlbum + "\\" + valorFoto);
                        ...
                        try
                        {
                            ...
                            Directory.Delete(caminhoAlvo + "Bustos Tratados\\" + valorAlbum);
                        }
                        catch { 
